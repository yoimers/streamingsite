...
const Button = {
  ...
  variants: {
    mainbutton: (props: any) => ({
      color: "white",
      rounded: "full",
      bg: mode(props.theme.colors.brand.maincolor, "blue.500")(props),
      _hover: { bg: mode("blue.600", "blue.600")(props) },
      _focus: { boxShadow: 0 },
      _active: { bg: mode("blue.800", "blue.700")(props) },
    }),
    subbutton: (props: any) => ({
      color: mode(props.theme.colors.brand.usercolor, "gray.200")(props),
      rounded: "full",
      bg: mode(props.theme.colors.brand.mygray2, "gray.600")(props),
